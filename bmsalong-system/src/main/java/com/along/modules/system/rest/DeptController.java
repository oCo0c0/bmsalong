...
public class DeptController {
    ...
    @PreAuthorize("@bms.check('dept:list')")
    ...
    @ApiOperation("查询部门")
    @GetMapping
    @PreAuthorize("@bms.check('user:list','dept:list')")
    ...
    @ApiOperation("新增部门")
    @PostMapping
    @PreAuthorize("@bms.check('dept:add')")
    ...
    @ApiOperation("修改部门")
    @PutMapping
    @PreAuthorize("@bms.check('dept:edit')")
    ...
    @ApiOperation("删除部门")
    @DeleteMapping
    @PreAuthorize("@bms.check('dept:del')")
