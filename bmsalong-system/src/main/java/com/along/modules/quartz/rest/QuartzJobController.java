 ...
 */
package com.along.modules.quartz.rest;
...
public class QuartzJobController {
    ...
    @ApiOperation("查询定时任务")
    @GetMapping
    @PreAuthorize("@bms.check('timing:list')")
    ...
    @ApiOperation("新增定时任务")
    @PostMapping
    @PreAuthorize("@bms.check('timing:add')")
    ...
    @ApiOperation("修改定时任务")
    @PutMapping
    @PreAuthorize("@bms.check('timing:edit')")
    ...
    @ApiOperation("删除定时任务")
    @DeleteMapping
    @PreAuthorize("@bms.check('timing:del')")
