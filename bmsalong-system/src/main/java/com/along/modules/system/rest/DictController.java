...
import com.along.modules.system.service.DictService;
import com.along.modules.system.domain.vo.DictQueryCriteria;
...
public class DictController {
    ...
    @PreAuthorize("@bms.check('dict:list')")
    ...
    @ApiOperation("新增字典")
    @PostMapping
    @PreAuthorize("@bms.check('dict:add')")
    ...
    @ApiOperation("修改字典")
    @PutMapping
    @PreAuthorize("@bms.check('dict:edit')")
    ...
    @ApiOperation("删除字典")
    @DeleteMapping
    @PreAuthorize("@bms.check('dict:del')")
